"use strict";
(self["webpackChunkreact_host_nextjs_remote_host"] = self["webpackChunkreact_host_nextjs_remote_host"] || []).push([[229],{
...
*/
var aa=__webpack_require__(122),ca=__webpack_require__(840);function p(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return"Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}var da=new Set,ea={};function fa(a,b){ha(a,b);ha(a+"Capture",b)}
...
class RenderErrorBoundary extends index_js_.Component {
  ...
  render() {
    return this.state.error ? /*#__PURE__*/index_js_.createElement(RouteContext.Provider, {
...
function dist_RouterProvider(_ref) {
  ...
  return /*#__PURE__*/index_js_.createElement(index_js_.Fragment, null, /*#__PURE__*/index_js_.createElement(DataRouterContext.Provider, {
    ...
    value: vtContext
  }, /*#__PURE__*/index_js_.createElement(dist_Router, {
    basename: basename,
    location: state.location,
    navigationType: state.historyAction,
    navigator: navigator
  }, state.initialized ? /*#__PURE__*/index_js_.createElement(dist_DataRoutes, {
    routes: router.routes,
    state: state
  }) : fallbackElement))))), null);
}
